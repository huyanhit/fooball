                ...
                <ul class="navbar-nav" id="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link menu-link collapsed active" href="#sidebarLayouts" data-bs-toggle="collapse" role="button" aria-expanded="true" aria-controls="sidebarLayouts">
                            <i class="ri-layout-3-line"></i> <span data-key="t-layouts">Trang</span> <span class="badge badge-pill bg-danger" data-key="t-hot">Hot</span>
                        </a>
                        <div class="collapse menu-dropdown show dropdown-custom-right" id="sidebarLayouts">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    <b-link to="country" target="_blank" class="nav-link active" data-key="t-horizontal">country</b-link>
                                </li>
                                <li class="nav-item">
                                    <b-link to="league" target="_blank" class="nav-link" data-key="t-detached">league</b-link>
                                </li>
                                <li class="nav-item">
                                    <b-link to="bookmaker" target="_blank" class="nav-link" data-key="t-two-column">bookmaker</b-link>
                                </li>
                                <li class="nav-item">
                                    <b-link to="schedule" target="_blank" class="nav-link" data-key="t-hovered">schedule</b-link>
                                </li>
                                <li class="nav-item">
                                    <b-link to="result" target="_blank" class="nav-link" data-key="t-hovered">result</b-link>
                                </li>
                            </ul>
                        </div>
