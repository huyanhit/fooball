            ...
            <div class="container-fluid dropdown-custom-right">
                ...
                <ul class="navbar-nav" id="navbar-nav">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse menu-dropdown dropdown-custom-right" id="sidebarDashboards">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse menu-dropdown dropdown-custom-right" id="sidebarApps">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    <a href="#sidebarCalendar" class="nav-link collapsed" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarCalendar" data-key="t-calender">
                                        Calendar
                                    </a>
                                    <div class="collapse menu-dropdown dropdown-custom-right" id="sidebarCalendar">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="collapse menu-dropdown dropdown-custom-right" id="sidebarTasks">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="collapse menu-dropdown dropdown-custom-right" id="sidebarCRM">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="collapse menu-dropdown dropdown-custom-right" id="sidebarCrypto">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="collapse menu-dropdown dropdown-custom-right" id="sidebarInvoices">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="collapse menu-dropdown dropdown-custom-right" id="sidebarTickets">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="collapse menu-dropdown dropdown-custom-right" id="sidebarnft">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a href="#sidebarjobs" class="nav-link collapsed" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarjobs" data-key="t-jobs">Jobs</a>
                                    <div class="collapse menu-dropdown dropdown-custom-right" id="sidebarjobs">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                            ...
                                            <li class="nav-item">
                                                ...
                                                <div class="collapse menu-dropdown dropdown-custom-right" id="sidebarJoblists">
                                                    <ul class="nav nav-sm flex-column">
                                                        <li class="nav-item">
                                            ...
                                            <li class="nav-item">
                                                ...
                                                <div class="collapse menu-dropdown dropdown-custom-right" id="sidebarCandidatelists">
                                                    <ul class="nav nav-sm flex-column">
                                                        <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link menu-link collapsed active" href="#sidebarLayouts" data-bs-toggle="collapse" role="button" aria-expanded="true" aria-controls="sidebarLayouts">
                        ...
                        <div class="collapse menu-dropdown show dropdown-custom-right" id="sidebarLayouts">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    <a href="layouts-horizontal.html" target="_blank" class="nav-link active" data-key="t-horizontal">Horizontal</a>
                                </li>
                                <li class="nav-item">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse menu-dropdown dropdown-custom-right" id="sidebarAuth">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    ...
                                    <div class="collapse menu-dropdown dropdown-custom-right" id="sidebarSignIn">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="collapse menu-dropdown dropdown-custom-right" id="sidebarSignUp">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="collapse menu-dropdown dropdown-custom-right" id="sidebarResetPass">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="collapse menu-dropdown dropdown-custom-right" id="sidebarchangePass">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="collapse menu-dropdown dropdown-custom-right" id="sidebarLockScreen">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="collapse menu-dropdown dropdown-custom-right" id="sidebarLogout">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="collapse menu-dropdown dropdown-custom-right" id="sidebarSuccessMsg">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="collapse menu-dropdown dropdown-custom-right" id="sidebarTwoStep">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="collapse menu-dropdown dropdown-custom-right" id="sidebarErrors">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                    ...
                    </li><li class="nav-item">						<a class="nav-link collapsed" href="#sidebarMore" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarMore">							<i class="ri-briefcase-2-line"></i> <span data-key="t-more">More</span>						</a>						<div class="collapse menu-dropdown" id="sidebarMore"><ul class="nav nav-sm flex-column"><li class="nav-item">
